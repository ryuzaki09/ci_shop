...
class Usermodel extends Commonmodel {
    ...
    public function db_get_user($email, $password){
    ...
    public function insert_new_pending_account($data){
    ...
    public function activate_account($where){
    ...
    public function insert_forgot_pwd($uid, $reset_code){
	$this->db->set('uid', $uid);
    ...
    public function check_forgot_pwd_user($where){
	$this->db->where($where);
    ...
    public function reset_password($forgot_id, $pwd, $uid){
    ...
    public function db_get_userdetails($uid){
	$this->db->where('uid', $uid);
    ...
    public function db_update_userdetails($data, $uid){
	$this->db->where('uid', $uid);
