...
<div id="parent_dialog" title="Edit Parent Menu"><!-- PARENT MENU DIALOG -->
	...
	<input type="submit" name="update_menu" value="Update" />
	</form>
</div>
...
<div id="sub_dialog" title="Edit Sub Menu"><!-- SUB MENU DIALOG -->
	...
	<div class="clearfix">
		<div class="block150 go_left">Url: <br /><span class="note">shop.longdestiny.com/</span></div><input type="text" id="suburl" name="suburl" class="go_left block200" />
	</div>
